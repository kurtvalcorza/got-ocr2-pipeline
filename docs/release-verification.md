...
| Date (UTC) | Commit / notebook blob | Executor | Path exercised | Wall | Outcome |
|---|---|---|---|---|---|
| 2026-09-14 | `70b4431` / `84828c509441` | Kaggle CPU (`kurtvalcorza/dimer-nb2-got-ocr2` v1) | Default sample path | 300.9 s | **PASSED** — 8/8 ok code cells executed cleanly, 18 files, 1140 MB staged |
