...
- **Build record (Tesla T4, seed 42 split):** frozen CER 1.345 / WER 1.780 on the 140 held-out lines (worse than the empty baseline's 1.0 — the model invents printed-looking text), adapted **0.759** / **1.017** (epoch 4 of 6, 3 lines exact), reload parity 8/8. One seeded split of one 800-line sample; no dispersion estimate.
