...
- Tutorial execution: `tutorials/got_ocr2_colab.ipynb` ran top-to-bottom in a fresh local kernel; recorded in `docs/release-verification.md` as pre-flight, not supported-runtime evidence.
